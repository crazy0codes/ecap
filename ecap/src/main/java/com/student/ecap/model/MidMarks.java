package com.student.ecap.model; // Corrected package to match other models
...
public class MidMarks {
    ...
    private Student student; // Now correctly referencing com.example.sms.model.Student
    ...
    private Course course; // Now correctly referencing com.example.sms.model.Course
    ...
    private Semester semester; // Now correctly referencing com.example.sms.model.Semester
    ...
    private MidExam midExam; // Now correctly referencing com.example.sms.model.MidExam
